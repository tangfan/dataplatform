...
public abstract class DataMoniterServantPrxCallback extends com.qq.taf.proxy.ServantProxyCallback
{
    protected String __datamoniterservant__DataMoniterServant_all[] = 
    {
        "test"
    };
    ...
    final public int _onDispatch(String sFuncName, com.qq.taf.ResponsePacket response)
    {
        ...
        int iPos = java.util.Arrays.binarySearch(__datamoniterservant__DataMoniterServant_all, sFuncName);
